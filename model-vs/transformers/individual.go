...
// IndividualDataToAPI contains the model-building step of the data-model-to-api-model transformer.
...
// IndividualAPIToData contains the model-building step of the api-model-to-data-model transformer.
